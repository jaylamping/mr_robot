...
export function MotorControl({ canId, currentAngleRad }: MotorControlProps) {
    ...
    <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-4 space-y-4">
      ...
      <div className="border-t border-zinc-800 pt-4">
        ...
        <ActionButton
          ...
          onClick={() =>
            exec(() =>
              moveMotor(canId, (positionDeg * Math.PI) / 180, kp, kd),
            )
          }
          variant="blue"
        />
  ...
  return (
    <div>
      ...
      <ActionButton
        ...
        disabled={busy}
        onClick={() =>
          exec(() => controlMotor(canId, pos, vel, rkp, rkd, trq))
        }
        variant="default"
      />
    </div>
